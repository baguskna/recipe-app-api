...
class PrivateIngredientApiTest(TestCase):
    ...
    def test_ingredient_limited_to_user(self):
        ...
        ingredient = Ingredient.objects.create(user=self.user, name='Other Paper')
    ...
    def test_create_ingredient_invalid(self):
        """Test creating a new invalid payload ingredient"""
        payload = {'name': ''}
    ...
    def test_retrieve_ingredients_assigned_to_recipes(self):
        ...
        ingredient2 = Ingredient.objects.create(user=self.user, name='Paperoni')
        recipe = Recipe.objects.create(
            title='Coriander egg with toast',
            time_minutes=10,
            price=5.00,
            user=self.user
        )
    ...
    def test_retrieve_ingredients_assigned_unique(self):
        ...
        Ingredient.objects.create(user=self.user, name='Paperoni')
